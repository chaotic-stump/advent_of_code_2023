...
def calc_nums arr
  total = 0
  arr.each do |str|
    str = str.gsub("sevenine", "79")
    str = str.gsub("nineight", "98")
    str = str.gsub("eighthree", "83")
    str = str.gsub("eightwo", "82")
    str = str.gsub("oneight", "18")
    str = str.gsub("threeight", "38")
    str = str.gsub("fiveight", "58")

    str = str.gsub("nine", "9")
    str = str.gsub("eight", "8")
    str = str.gsub("seven", "7")
    str = str.gsub("six", "6")
    str = str.gsub("five", "5")
    str = str.gsub("four", "4")
    str = str.gsub("three", "3")
    str = str.gsub("two", "2")
    str = str.gsub("one", "1")
    num = str.gsub(/[^0-9]/, '')
    pair = num[0] + num[-1]

    total = total + pair.to_i
  end
  return total
end

puts calc_nums input
